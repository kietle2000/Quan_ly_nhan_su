...
const ZALO_APP_ID     = process.env.ZALO_APP_ID     || '3872938296996027660';
const ZALO_SECRET_KEY = process.env.ZALO_SECRET_KEY || 'v65u7m88vP35YcJ88P38';
const INITIAL_REFRESH_TOKEN = process.env.ZALO_REFRESH_TOKEN || 'KdHv3vO7CHbTT7aAbmm-7rPwUGoL5LWU5XDiIgOcK0uyFNL2Z4bA2X9HRLsrOaK8C1OCJhOXFWyYDWmPcI0xJ1y5VJYeCLXH30TXBiyFOanlA5y8xYfgUbWEI3tx2MbMUNzN9RjG44W-UILPgtOBIo84I2UW6d9Z925L9wOrQ6OyDrLxgKDf2M9aJKtpV5a5C51vQVDGFIqsHNbxy3T55aWzVXwFI5rZEqKUTRrgDmStHmnbzLCu2rac1NRBNYSX2IrlOyiYB7DQ6H5bvIXDCr8DTsNj8589RXiQ7iqLFGrjE09vsIfACqzTN73uRKGNRs02LgXHHXukM0Hnx2eU9cPSF7BaBtyvNLb2A_rlTMCw5b0Nh0OGGX0_DIxM2YXcK188S9CrDpS15p1-tnaBQtmxBYDByq5n9PKREn8';
const ZALO_PROXY_URL  = process.env.ZALO_PROXY_URL  || 'https://nhanphuphuyen.edu.vn/zalo_proxy.php';
